...
class SCryptoTests: XCTestCase {
    ...
    func testMD2() {
        digest(message: Consts.message, expectedDigest: Consts.MD2) { $0.MD2() }
        XCTAssertEqual(Consts.message.MD2(), Consts.MD2)
    }

    func testMD4() {
        digest(message: Consts.message, expectedDigest: Consts.MD4) { $0.MD4() }
        XCTAssertEqual(Consts.message.MD4(), Consts.MD4)
    }

    func testMD5() {
        digest(message: Consts.message, expectedDigest: Consts.MD5) { $0.MD5() }
        XCTAssertEqual(Consts.message.MD5(), Consts.MD5)
    }

    func testSHA1() {
        digest(message: Consts.message, expectedDigest: Consts.SHA1) { $0.SHA1() }
        XCTAssertEqual(Consts.message.SHA1(), Consts.SHA1)
    }

    func testSHA224() {
        digest(message: Consts.message, expectedDigest: Consts.SHA224) { $0.SHA224() }
        XCTAssertEqual(Consts.message.SHA224(), Consts.SHA224)
    }

    func testSHA256() {
        digest(message: Consts.message, expectedDigest: Consts.SHA256) { $0.SHA256() }
        XCTAssertEqual(Consts.message.SHA256(), Consts.SHA256)
    }

    func testSHA384() {
        digest(message: Consts.message, expectedDigest: Consts.SHA384) { $0.SHA384() }
        XCTAssertEqual(Consts.message.SHA384(), Consts.SHA384)
    }

    func testSHA512() {
        digest(message: Consts.message, expectedDigest: Consts.SHA512) { $0.SHA512() }
        XCTAssertEqual(Consts.message.SHA512(), Consts.SHA512)
    }

    private func digest(message: String, expectedDigest: String, algorithm: (Data) -> Data) {
    ...
    func testHMAC_MD5() {
        hmac(algorithm: .md5, key: Consts.key, message: Consts.message, expectedHMAC: Consts.hmacMD5)
    }

    func testHMAC_SHA1() {
        hmac(algorithm: .sha1, key: Consts.key, message: Consts.message, expectedHMAC: Consts.hmacSHA1)
    }

    func testHMAC_SHA256() {
        hmac(algorithm: .sha256, key: Consts.key, message: Consts.message, expectedHMAC: Consts.hmacSHA256)
    }

    func testHMAC_SHA384() {
        hmac(algorithm: .sha384, key: Consts.key, message: Consts.message, expectedHMAC: Consts.hmacSHA384)
    }

    func testHMAC_SHA512() {
        hmac(algorithm: .sha512, key: Consts.key, message: Consts.message, expectedHMAC: Consts.hmacSHA512)
    }

    func testHMAC_SHA224() {
        hmac(algorithm: .sha224, key: Consts.key, message: Consts.message, expectedHMAC: Consts.hmacSHA224)
    }
    ...
    func testDerivedKey_SHA1() {
        calibrate(password: Consts.key, saltLength: Consts.pbkdfSalt.data(using: String.Encoding.utf8)!.count, pseudoRandomAlgorithm: .sha1, derivedKeyLength: 16, msec: 100)
        PBKDF2(password: Consts.key, salt: Consts.pbkdfSalt, pseudoRandomAlgorithm: .sha1, rounds: 20, derivedKeyLength: 16, expectedDerivedKey: Consts.pbkdfSHA1)
    }

    func testDerivedKey_SHA256() {
        calibrate(password: Consts.key, saltLength: Consts.pbkdfSalt.data(using: String.Encoding.utf8)!.count, pseudoRandomAlgorithm: .sha256, derivedKeyLength: 32, msec: 100)
        PBKDF2(password: Consts.key, salt: Consts.pbkdfSalt, pseudoRandomAlgorithm: .sha256, rounds: 20, derivedKeyLength: 32, expectedDerivedKey: Consts.pbkdfSHA256)
    }

    func testDerivedKey_SHA512() {
        calibrate(password: Consts.key, saltLength: Consts.pbkdfSalt.data(using: String.Encoding.utf8)!.count, pseudoRandomAlgorithm: .sha512, derivedKeyLength: 64, msec: 100)
        PBKDF2(password: Consts.key, salt: Consts.pbkdfSalt, pseudoRandomAlgorithm: .sha512, rounds: 20, derivedKeyLength: 64, expectedDerivedKey: Consts.pbkdfSHA512)
    }
    ...
    func testAES_CBC_128() {
        cipher(plaintext: Consts.aesPlaintext, key: Consts.aesKey_128, IV: nil, expectedCyphertext: Consts.aesCiphertext_CBC_128, algorithm: .aes, options: [])
        cipher(plaintext: Consts.aesPlaintext, key: Consts.aesKey_128, IV: Consts.aesIV_128, expectedCyphertext: Consts.aesCiphertext_CBC_128_IV, algorithm: .aes, options: [])
        cipher(plaintext: Consts.message.data(using: String.Encoding.utf8)!.base64EncodedString(options: []), key: Consts.aesKey_128, IV: nil, expectedCyphertext: Consts.aesCiphertext_CBC_128_Padding, algorithm: .aes, options: .PKCS7Padding)
    }

    func testAES_CBC_256() {
        cipher(plaintext: Consts.aesPlaintext, key: Consts.aesKey_256, IV: nil, expectedCyphertext: Consts.aesCiphertext_CBC_256, algorithm: .aes, options: [])
        cipher(plaintext: Consts.aesPlaintext, key: Consts.aesKey_256, IV: Consts.aesIV_256, expectedCyphertext: Consts.aesCiphertext_CBC_256_IV, algorithm: .aes, options: [])
        cipher(plaintext: Consts.message.data(using: String.Encoding.utf8)!.base64EncodedString(options: []), key: Consts.aesKey_256, IV: nil, expectedCyphertext: Consts.aesCiphertext_CBC_256_Padding, algorithm: .aes, options: .PKCS7Padding)
    }
    ...
    func cipher(plaintext: String, key: String, IV: String?, expectedCyphertext: String, algorithm: Cipher.Algorithm, options: Cipher.Options) {
        ...
        XCTAssertEqual(ciphertext.base64EncodedString(options: []), expectedCyphertext)
    }
